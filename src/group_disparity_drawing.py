...
plt.ylabel("Disparity (Spherical Variance, log scale)", fontsize=14)
plt.title(f"Model Comparison: Phenotypic disparity as a function of diversity ({LEVEL}-level)", fontsize=16)
plt.legend()
