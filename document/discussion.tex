...
organisms, for instance, comparing the phenotypic disparity among animals, fungi, and plants.

In contrast, the difficulty in aligning extinct species with extant species highlights its limitations. This method also
has difficulties in measuring inner structure of organisms. Moreover, despite our previous discussion on the
interpretability of models, this is still a major weakness of this novel method, especially compared to geometric
methods. This also restricts its applicability in comparative studies on the difference (mosaic evolution)
between different body parts (e.g., beak vs. claw) or different geometrics (e.g., full length vs. weight).
