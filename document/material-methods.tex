...
employed to visualise the model's attention on images. We furtherly utilise aenerative adversarial
examples with a semantic conflict between the object's body plan and feather texture,
to evaluate the priority between texture versus shape.
